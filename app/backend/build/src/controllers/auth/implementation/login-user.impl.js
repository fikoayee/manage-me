...
const login = (loginBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ userId: user._id, email: user.email }, "8f6e27b1e3d6e1a9170fc3cba5d8c4e0b22e5f92f9b7f8246c5c2e4b5ed2f89ef", { expiresIn: "1h" });
